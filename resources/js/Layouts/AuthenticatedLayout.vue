    ...
    <div class="flex flex-col h-screen">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">
                        ...
                        >
                            ...
                            <span
                                class="self-center text-md font-semibold whitespace-nowrap text-zinc-700 dark:text-white"
                            >
                                Toko Mas Bina Nusa
                            </span>
                        </Link>
        ...
        <div class="flex flex-row flex-1 min-h-0 overflow-hidden">
            ...
            >
                <div>
                    <h3
                        className="mb-4 ml-4 text-sm font-semibold text-gray-500"
                    >
                        Main
                    </h3>
                ...
                <div>
                    ...
                    <ul className="mb-6 flex flex-col gap-1.5">
                        ...
                        />
                        <SidebarLink
                            :link="route('safeboxes.index')"
                            label="Brankas"
                            icon="vault"
                            :active="route().current('safeboxes*')"
                        />
                        <SidebarLink
                            :link="route('prices.index')"
                            label="Harga dan Kadar"
                            icon="percentage"
            ...
            <div
                ...
                class="p-4 md:p-6 bg-zinc-50 flex-1 overflow-y-auto no-scrollbar"
            >
                <transition name="fade">
                    <div
                        v-if="showingSidebar"
