...
const form = useForm({
    ...
    indentity_number: props.user.indentity_number || "",
...
const onSubmit = () => {
    form.post(route("employees.update", props.user.id), {
        onSuccess: () => {
            Swal.fire({
                title: "Berhasil",
                icon: "success",
                    ...
                    <div class="w-full md:w-1/2 space-y-6">
                        <div>
                            ...
                            <TextInput
                                ...
                                placeholder="Masukan password (kosongkan jika tidak ingin mengganti password)"
                            />
                    ...
                    <div class="w-full md:w-1/2 space-y-6">
                        <div>
                            ...
                            <TextInput
                                ...
                                placeholder="Ulangi password (kosongkan jika tidak ingin mengganti password)"
                            />
                        </div>
                    </div>
                </div>
