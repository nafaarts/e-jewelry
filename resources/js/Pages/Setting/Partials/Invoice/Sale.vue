...
<template>
    <div>
        <form class="space-y-3" @submit.prevent="updateSetting">
            <h3 class="text-base font-medium text-gray-900">Penjualan</h3>

            <div class="flex flex-col-reverse md:flex-row gap-3">
                <div class="w-full md:w-2/3">
                    <InputLabel value="Gambar Header" />
                    <FileInput id="sale_header_image" v-model="form.header_image" accept="image/*" @input="onUpdateImage" />
            ...
            <div class="flex flex-col md:flex-row gap-3">
                <div class="w-full md:w-2/3">
                    <label for="sale_header_image">
                        <div class="border rounded p-2 bg-gray-100 h-32">
                            <img class="mx-auto rounded max-h-28" :src="imagePreview" alt="Header sale">
                        </div>
                    </label>
                </div>
                <div class="w-full md:w-1/3">
