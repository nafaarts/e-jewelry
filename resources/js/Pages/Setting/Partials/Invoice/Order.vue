...
<template>
    <div>
        <form class="space-y-3" @submit.prevent="updateSetting">
            <h3 class="text-base font-medium text-gray-900">Tempahan</h3>

            <div class="flex flex-col-reverse md:flex-row gap-3">
                <div class="w-full md:w-2/3">
                    <InputLabel value="Gambar Header" />
                    <FileInput id="order_header_image" v-model="form.header_image" accept="image/*"
                        @input="onUpdateImage" />
