    ...
    <AuthenticatedLayout>
        ...
        <template #header>
            <div class="flex justify-between">
                ...
                <Link as="button" :href="route('orders.create')"
        ...
        <div class="bg-white overflow-hidden sm:rounded-lg border">
            <Table>
                ...
                <tr class="bg-white border-b" v-for="order in orders.data" :key="order.id">
                    <td class="px-4 py-2">
                    ...
                    <td class="px-4 py-2">
                        ...
                        <p class="w-fit max-w-xs truncate font-medium text-red-600" v-else>
                            {{ currencyFormatter.format(order.total_price - order.paid_amount) }}
                        </p>
                    </td>
                    <td class="px-4 py-2">
                        {{
                    ...
                    <td class="px-4 py-2">
                        <div class="flex gap-3">
                            <Link as="button" :href="route('orders.show', order)"
