...
<template>
    ...
    <InvoiceWrapper :size="config.invoice_service_paper_size" :backRoute="route('services.show', service.id)">
        <img class="absolute top-0 left-0" :src="`/storage/${config.invoice_service_header_image}`" alt="header">

        <div>
            <h1 class="text-lg font-bold underline text-center mt-5 mb-8">SERVICE</h1>
            ...
            <div class="py-4">
                <h3 class="text-xs font-bold mb-2">Detail Service</h3>
                <div class="relative">
