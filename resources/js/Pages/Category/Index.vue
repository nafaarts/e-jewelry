    ...
    <AuthenticatedLayout>
        ...
        <template #header>
            <div class="flex justify-between">
                ...
                <Link as="button" :href="route('categories.create')"
        ...
        <div class="bg-white overflow-hidden sm:rounded-lg border">
            <Table>
                ...
                <tr class="bg-white border-b" v-for="category in categories.data" :key="category.id">
                    <td class="px-4 py-2">
                    ...
                    <td class="px-4 py-2">
                        <div class="flex gap-3">
                            <Link as="button" :href="route('categories.edit', category.id)"
