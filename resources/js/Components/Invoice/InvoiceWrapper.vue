...
<template>
    <div
        class="flex justify-center items-center bg-zinc-100 h-screen overflow-auto"
    >
        <div
            class="page flex flex-col bg-white"
            :class="{
                'scale-75 md:scale-100': props.size === 'A5',
                'scale-50 md:scale-75': props.size === 'A4',
            }"
            id="print-area"
            :style="defaultVariable"
        >
            <slot />
        </div>

        <div
            class="fixed flex gap-2 left-5 top-5 p-3 rounded shadow-sm bg-white"
        >
